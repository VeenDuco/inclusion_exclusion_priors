...
plt.tight_layout()
plt.savefig("output/mean_recall_in_exclusion_cleaned_criteria.png") 
...
plt.tight_layout()
plt.savefig("output/mean_recall_1plus1_cleaned_criteria.png") 
...
plt.tight_layout()
plt.savefig("output/mean_recall_together_cleaned_criteria.png") 
