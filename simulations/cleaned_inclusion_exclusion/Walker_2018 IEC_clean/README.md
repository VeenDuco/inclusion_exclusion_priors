...
- data\prior_Walker_2018_clean.csv
- data\Walker_2018.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Walker_2018_clean.csv
        |   ├── 📜tds_sim_prior_Walker_2018_clean.xlsx
        |   ├── 📜tds_sim_Walker_2018.csv
        |   ├── 📜tds_sim_Walker_2018.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_Walker_2018_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Walker_2018_clean_metrics.xlsx
        |   ├── 📜metrics_sim_Walker_2018_metrics.csv
        |   ├── 📜metrics_sim_Walker_2018_metrics.xlsx
        |   ├── 📜metrics_summary.csv
