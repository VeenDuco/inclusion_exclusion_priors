...
- data\prior_van_der_Waal_2022_clean.csv
- data\van_der_Waal_2022.csv
...
The following files are found in this project:
    ...
    ├── 📜jobs.bat
    ├── 📂data
    │   ├── 📜prior_van_der_Waal_2022_clean.csv
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_van_der_Waal_2022_clean.csv
        |   ├── 📜tds_sim_prior_van_der_Waal_2022_clean.xlsx
        |   ├── 📜tds_sim_van_der_Waal_2022.csv
        |   ├── 📜tds_sim_van_der_Waal_2022.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_van_der_Waal_2022_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_van_der_Waal_2022_clean_metrics.xlsx
        |   ├── 📜metrics_sim_van_der_Waal_2022_metrics.csv
        |   ├── 📜metrics_sim_van_der_Waal_2022_metrics.xlsx
        |   ├── 📜metrics_summary.csv
