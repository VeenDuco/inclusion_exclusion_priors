...
- data\prior_Radjenovic_2013_clean.csv
- data\Radjenovic_2013.csv
...
The following files are found in this project:
    ...
    ├── 📜jobs.bat
    ├── 📂data
    │   ├── 📜prior_Radjenovic_2013_clean.csv
    │   ├── 📜Radjenovic_2013.csv
    ├── 📂generated_data
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Radjenovic_2013_clean.csv
        |   ├── 📜tds_sim_prior_Radjenovic_2013_clean.xlsx
        |   ├── 📜tds_sim_Radjenovic_2013.csv
        |   ├── 📜tds_sim_Radjenovic_2013.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_Radjenovic_2013_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Radjenovic_2013_clean_metrics.xlsx
        |   ├── 📜metrics_sim_Radjenovic_2013_metrics.csv
        |   ├── 📜metrics_sim_Radjenovic_2013_metrics.xlsx
        |   ├── 📜metrics_summary.csv
