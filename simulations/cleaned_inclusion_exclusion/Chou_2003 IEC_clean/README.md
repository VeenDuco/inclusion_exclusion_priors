...
- data\Chou_2003.csv
- data\prior_Chou_2003_clean.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_Chou_2003.csv
        |   ├── 📜tds_sim_Chou_2003.xlsx
        |   ├── 📜tds_sim_prior_Chou_2003_clean.csv
        |   ├── 📜tds_sim_prior_Chou_2003_clean.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Chou_2003_metrics.csv
        |   ├── 📜metrics_sim_Chou_2003_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Chou_2003_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Chou_2003_clean_metrics.xlsx
        |   ├── 📜metrics_summary.csv
