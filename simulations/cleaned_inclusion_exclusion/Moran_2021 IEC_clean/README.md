...
- data\Moran_2021.csv
- data\prior_Moran_2021_clean.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Moran_2021_clean.csv
        |   ├── 📜tds_sim_prior_Moran_2021_clean.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Moran_2021_metrics.csv
        |   ├── 📜metrics_sim_Moran_2021_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Moran_2021_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Moran_2021_clean_metrics.xlsx
        |   ├── 📜metrics_summary.csv
