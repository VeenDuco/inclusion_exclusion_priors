...
python -m asreview simulate generated_data\dataset_with_priors.csv -s output\simulation\state_files\sim_with_priors.asreview --seed 165 -m nb -e tfidf -q max -b double --n_instances 1 --stop_if min --prior_idx 5214 5215
