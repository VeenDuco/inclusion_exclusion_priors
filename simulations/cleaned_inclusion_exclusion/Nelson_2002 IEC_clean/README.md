...
- data\Nelson_2002.csv
- data\prior_Nelson_2002_clean.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_Nelson_2002.csv
        |   ├── 📜tds_sim_Nelson_2002.xlsx
        |   ├── 📜tds_sim_prior_Nelson_2002_clean.csv
        |   ├── 📜tds_sim_prior_Nelson_2002_clean.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Nelson_2002_metrics.csv
        |   ├── 📜metrics_sim_Nelson_2002_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Nelson_2002_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Nelson_2002_clean_metrics.xlsx
        |   ├── 📜metrics_summary.csv
