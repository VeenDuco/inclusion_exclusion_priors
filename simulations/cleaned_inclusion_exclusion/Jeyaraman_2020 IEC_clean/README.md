...
- data\prior_Jeyaraman_2020_clean.csv
...
The following files are found in this project:
    ...
    ├── 📂data
    │   ├── 📜Jeyaraman_2020.csv
    │   ├── 📜prior_Jeyaraman_2020_clean.csv
    ├── 📂generated_data
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Jeyaraman_2020_clean.csv
        |   ├── 📜tds_sim_prior_Jeyaraman_2020_clean.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Jeyaraman_2020_metrics.csv
        |   ├── 📜metrics_sim_Jeyaraman_2020_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Jeyaraman_2020_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Jeyaraman_2020_clean_metrics.xlsx
        |   ├── 📜metrics_summary.csv
