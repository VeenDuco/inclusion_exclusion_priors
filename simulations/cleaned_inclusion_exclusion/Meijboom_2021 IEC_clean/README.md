...
- data\Meijboom_2021.csv
- data\prior_Meijboom_2021_clean.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_Meijboom_2021.csv
        |   ├── 📜tds_sim_Meijboom_2021.xlsx
        |   ├── 📜tds_sim_prior_Meijboom_2021_clean.csv
        |   ├── 📜tds_sim_prior_Meijboom_2021_clean.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Meijboom_2021_metrics.csv
        |   ├── 📜metrics_sim_Meijboom_2021_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Meijboom_2021_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_Meijboom_2021_clean_metrics.xlsx
        |   ├── 📜metrics_summary.csv
