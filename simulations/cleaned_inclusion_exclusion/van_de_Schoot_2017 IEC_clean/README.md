...
- data\prior_van_de_Schoot_2018_clean.csv
...
The following files are found in this project:
    ...
    ├── 📜jobs.bat
    ├── 📂data
    │   ├── 📜prior_van_de_Schoot_2018_clean.csv
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_van_de_Schoot_2018_clean.csv
        |   ├── 📜tds_sim_prior_van_de_Schoot_2018_clean.xlsx
        |   ├── 📜tds_sim_van_de_Schoot_2018.csv
        |   ├── 📜tds_sim_van_de_Schoot_2018.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_van_de_Schoot_2018_clean_metrics.csv
        |   ├── 📜metrics_sim_prior_van_de_Schoot_2018_clean_metrics.xlsx
