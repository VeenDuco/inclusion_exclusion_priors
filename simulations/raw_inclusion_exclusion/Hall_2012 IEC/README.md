...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Hall_2012.csv
        |   ├── 📜tds_sim_prior_Hall_2012.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Hall_2012_metrics.csv
        |   ├── 📜metrics_sim_Hall_2012_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Hall_2012_metrics.csv
        |   ├── 📜metrics_sim_prior_Hall_2012_metrics.xlsx
        |   ├── 📜metrics_summary.csv
