...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Wassenaar_2017.csv
        |   ├── 📜tds_sim_prior_Wassenaar_2017.xlsx
        |   ├── 📜tds_sim_Wassenaar_2017.csv
        |   ├── 📜tds_sim_Wassenaar_2017.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_Wassenaar_2017_metrics.csv
        |   ├── 📜metrics_sim_prior_Wassenaar_2017_metrics.xlsx
