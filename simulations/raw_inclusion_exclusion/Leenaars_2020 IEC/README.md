...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Leenaars_2020.csv
        |   ├── 📜tds_sim_prior_Leenaars_2020.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Leenaars_2020_metrics.csv
        |   ├── 📜metrics_sim_Leenaars_2020_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Leenaars_2020_metrics.csv
        |   ├── 📜metrics_sim_prior_Leenaars_2020_metrics.xlsx
        |   ├── 📜metrics_summary.csv
