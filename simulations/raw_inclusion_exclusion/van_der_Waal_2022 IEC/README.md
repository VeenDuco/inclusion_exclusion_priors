...
- data\prior_van_der_Waal_2022.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_van_der_Waal_2022.csv
        |   ├── 📜tds_sim_prior_van_der_Waal_2022.xlsx
        |   ├── 📜tds_sim_van_der_Waal_2022.csv
        |   ├── 📜tds_sim_van_der_Waal_2022.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_van_der_Waal_2022_metrics.csv
        |   ├── 📜metrics_sim_prior_van_der_Waal_2022_metrics.xlsx
