...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_Chou_2003.csv
        |   ├── 📜tds_sim_prior_Chou_2003.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_Chou_2003_metrics.csv
        |   ├── 📜metrics_sim_Chou_2003_metrics.xlsx
        |   ├── 📜metrics_sim_prior_Chou_2003_metrics.csv
        |   ├── 📜metrics_sim_prior_Chou_2003_metrics.xlsx
        |   ├── 📜metrics_summary.csv
