...
- data\prior_van_de_Schoot_2018.csv
...
The following files are found in this project:
    ...
    └── 📂output
        ...
        |   ├── 📜tds_sim_prior_van_de_Schoot_2018.csv
        |   ├── 📜tds_sim_prior_van_de_Schoot_2018.xlsx
        |   ├── 📜tds_sim_van_de_Schoot_2018.csv
        |   ├── 📜tds_sim_van_de_Schoot_2018.xlsx
        |   ├── 📜tds_summary.csv
        |   ├── 📜tds_summary.xlsx
        |   ├── 📜metrics_sim_prior_van_de_Schoot_2018_metrics.csv
        |   ├── 📜metrics_sim_prior_van_de_Schoot_2018_metrics.xlsx
